...
@section('logo')
    <img src="./images/Heraa1.png" alt="شركة حراء">
@endsection('logo')

@section('register-nav')
    class="active"
@endsection('register-nav')
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <h3 class="card-header">{{ __('التسجيل') }}</h3>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="image" class="col-md-4 col-form-label text-md-right">صورة المستخدم</label>
